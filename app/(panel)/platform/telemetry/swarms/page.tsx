  ...
  const filteredSwarms = swarms.filter((swarm) => {
    ...
    try {
      ...
      return (
        ...
        (swarm.description
          ? swarm.description.toLowerCase().includes(searchLower)
          : false) ||
        (swarm.swarmType
          ? swarm.swarmType.toLowerCase().includes(searchLower)
          : false) ||
    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="mt-1 space-y-2 text-zinc-900 dark:text-white">
          <p>
            Create and manage your swarms - coordinated groups of AI agents
            working together to accomplish complex tasks.
          </p>
          <p className="text-sm text-zinc-600 dark:text-zinc-400">
            A swarm is a collection of specialized agents that can work either
            sequentially or concurrently. Start by creating a new swarm and
            adding pre-built agents or creating custom agents to handle specific
            parts of your task.
          </p>
        </div>
      </div>
