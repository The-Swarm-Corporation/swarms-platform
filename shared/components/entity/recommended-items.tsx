  ...
  const animateTransition = (newItems: any[], direction: 'left' | 'right') => {
    ...
    setTimeout(() => {
      ...
      requestAnimationFrame(() => {
        ...
        }, 50); // Small delay before removing animation class
      });
    }, 400); // Increased from 150ms to 400ms for smoother transition
  };
    ...
    <section className="border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 sm:p-6 bg-white dark:bg-zinc-950/50 mb-8">
      ...
      <div className="relative overflow-hidden">
        <div className={cn(
          ...
          isAnimating && slideDirection === 'left' && "-translate-x-[100%] opacity-0",
          isAnimating && slideDirection === 'right' && "translate-x-[100%] opacity-0",
