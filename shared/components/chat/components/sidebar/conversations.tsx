...
import { ChevronLeft, ChevronRight, MessageSquare, MoreVertical, Plus, Download, Trash } from "lucide-react"
  ...
  return (
    ...
    >
      <div className="p-4 border-b border-red-600/20 flex items-center justify-between">
        {isExpanded && <h2 className="text-red-500 font-bold">Conversations</h2>}
        <Button variant="ghost" size="icon" onClick={() => setIsExpanded(!isExpanded)} className="text-red-500">
        ...
        <div className="p-4 space-y-2">
          {isLoading ? (
            ...
            Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="h-14 rounded-lg bg-red-500/5 animate-pulse" />
            ))
          ) : (
            <AnimatePresence>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium text-red-500 truncate">{conversation.name}</p>
                    ...
                    <div className="flex justify-center">
                      <div
                        className={`w-2 h-2 rounded-full ${
                          conversation.id === activeId ? "bg-red-500" : "bg-red-500/30"
                        }`}
                      />
                    </div>
                  )}
