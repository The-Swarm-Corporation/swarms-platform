  ...
  return (
    <>
      ...
      >
        ...
        <div className="h-screen overflow-y-auto md:h-auto">
          ...
          <div className="flex flex-col w-full">
              ...
              {!isSharedConversation && (
                ...
                >
                  ...
                  <Sheet open={openAgentModal} onOpenChange={setOpenAgentModal}>
                    ...
                    <SheetContent className='h-screen overflow-y-auto md:h-auto'>
                      <SheetHeader>
            ...
            <Dialog open={openAgentLibrary} onOpenChange={setOpenAgentLibrary}>
              ...
              <DialogContent className="max-w-3xl lg:max-w-[93.5vw] lg:left-auto lg:right-0 lg:-translate-x-0 max-h-[100vh] md:max-h-[85vh] lg:max-h-[100vh] h-full overflow-hidden flex flex-col border border-[#40403F]">
            ...
            <ScrollArea className="flex-1">
              <div className="p-4 space-y-2 h-[230px] md:h-[400px] lg:h-[780px] xl:h-[230px] 2xl:h-[300px]">
          ...
          <div
            className={cn(
              'p-4 border-t border-[#f9f9f914] pb-8 md:block',
          ...
          >
            <Button
              ...
              className={`${isExpanded ? 'w-full' : 'w-auto'} bg-primary/40 hover:bg-primary/70 text-white md:absolute md:bottom-8`}
            >
              {isUpdatePending ? (
