...
export const Keypad = () => {
  return (
    <div className="h-full rounded-md bg-[#050505] mx-1 p-1">
      ...
      <Row>
        <KBtn
          className="w-[4rem] items-end justify-start pl-[4px] pb-[2px]"
          childrenClassName="items-start"
        >
          shift
        </KBtn>
      ...
      <Row>
        ...
        <div className="w-[9rem] mt-[2px] h-7 p-[0.5px] rounded-[4px] flex flex-col justify-end items-center">
          <KBtn className="w-[2.1rem] h-3">
